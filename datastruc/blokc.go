...
func NewLeaveConfigBlock(pubkeystr string, prvkey *ecdsa.PrivateKey, ltx LeaveTx, peers []PeerIdentity, height int, ver int, prevhash [32]byte, syshash [32]byte) Block {
	bloc := Block{}
	bloc.Blockhead.Kind = "configblock"
	bloc.Blockhead.Ver = ver
	bloc.Blockhead.Height = height
...
func ConstructGenesisBlock(config []PeerIdentity, syshash [32]byte) Block {
	geneb := Block{}
